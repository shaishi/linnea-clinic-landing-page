...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "standard-1-title": "Dual-doctor review",
      "standard-1-desc": "Every treatment plan benefits from two medical perspectives and a shared standard of precision.",
      "standard-2-title": "Medical planning first",
      ...
      "temples-fillers-title": "Filler Control - Temples",
      ...
      "reviews-title": "Patient Experience",
      "reviews-subtitle": "Calm, precise and personal care",
      "review-google-btn": "Rate us on Google",
      "faq-kicker": "Questions we clarify",
      "faq-title": "Before any aesthetic decision",
      "faq-desc": "Thoughtful aesthetic medicine should leave you with clarity: what is recommended, why, what to expect and how follow-up works.",
      "faq-1-q": "Does the consultation require treatment?",
      "faq-1-a": "No. The consultation is a medical conversation and planning session. Treatment is recommended only when it is appropriate and aligned with your goals.",
      "faq-2-q": "How do I know which treatment is right for me?",
      "faq-2-a": "We begin with your goals, anatomy, medical background and timing. Sometimes the right plan is skin quality, sometimes injectables, and sometimes waiting or choosing a gentler sequence.",
      "faq-3-q": "Will the result look natural?",
      "faq-3-a": "That is the guiding principle. The plan is built around restraint, proportion and facial harmony so the result feels refined rather than obvious.",
      "faq-4-q": "When will I see results?",
      "faq-4-a": "It depends on the treatment. Some results are visible immediately, while neuromodulators and skin-quality treatments develop gradually over days or weeks.",
      "faq-5-q": "Are there side effects?",
      "faq-5-a": "Aesthetic treatments can involve temporary redness, swelling, tenderness or bruising, and every treatment carries risks. We review expected recovery and warning signs before treatment.",
      "faq-6-q": "What if I have a medical condition or sensitivity?",
      "faq-6-a": "You will complete preparation forms before the consultation. Relevant medical information is reviewed by the clinic so safety considerations are addressed before any treatment decision.",
      "faq-7-q": "Is there follow-up after treatment?",
      "faq-7-a": "Yes. Follow-up is part of the Linnéa experience. You receive aftercare guidance and the team checks in when appropriate.",
      "faq-8-q": "Can I reschedule?",
      "faq-8-a": "Yes. If a proposed time does not work or plans change, you can reply to the clinic and we will offer another option.",
      ...
      "review2-theme": "Still felt like me",
      ...
      "review5-theme": "Clear explanation",
      ...
      "review6-theme": "Attentive follow-up",
      ...
      "alt-temples-after": "After Temple Filler Refinement at Linnéa Clinic",
      "alt-temples-before": "Before Temple Filler Refinement at Linnéa Clinic",
    ...
    he: {
      ...
      "standard-1-title": "בדיקה על ידי שני רופאים",
      "standard-1-desc": "כל תוכנית טיפול נהנית משתי נקודות מבט רפואיות ומסטנדרט משותף של דיוק.",
      "standard-2-title": "תכנון רפואי לפני טיפול",
      ...
      "temples-fillers-title": "שליטה בחומרי מילוי - רקות",
      ...
      "reviews-title": "חוויית המטופלים",
      "reviews-subtitle": "ייעוץ רגוע, מדויק ואישי",
      "review-google-btn": "דרגו אותנו בגוגל",
      "faq-kicker": "שאלות שמבהירים מראש",
      "faq-title": "לפני כל החלטה אסתטית",
      "faq-desc": "רפואה אסתטית מדויקת צריכה להשאיר אותך עם בהירות: מה מומלץ, למה, למה לצפות ואיך עובד המעקב.",
      "faq-1-q": "האם הייעוץ מחייב טיפול?",
      "faq-1-a": "לא. הייעוץ הוא שיחה רפואית ותכנונית. טיפול מומלץ רק כאשר הוא מתאים, נכון ובאמת תואם את המטרות שלך.",
      "faq-2-q": "איך יודעים איזה טיפול מתאים לי?",
      "faq-2-a": "מתחילים מהמטרות, מבנה הפנים, הרקע הרפואי והתזמון. לפעמים התוכנית הנכונה היא איכות עור, לפעמים הזרקות, ולפעמים דווקא להמתין או לבחור רצף עדין יותר.",
      "faq-3-q": "האם התוצאה תיראה טבעית?",
      "faq-3-a": "זה העיקרון המוביל. התוכנית נבנית סביב איפוק, פרופורציה והרמוניית פנים, כדי שהתוצאה תרגיש מעודנת ולא בולטת מדי.",
      "faq-4-q": "מתי רואים תוצאה?",
      "faq-4-a": "זה תלוי בטיפול. חלק מהתוצאות נראות מיד, בעוד נוירומודולטורים וטיפולי איכות עור מתפתחים בהדרגה לאורך ימים או שבועות.",
      "faq-5-q": "האם יש תופעות לוואי?",
      "faq-5-a": "טיפולים אסתטיים יכולים לכלול אדמומיות, נפיחות, רגישות או שטפי דם זמניים, ולכל טיפול קיימים סיכונים. לפני טיפול נסביר מה צפוי ומה דורש פנייה לצוות.",
      "faq-6-q": "מה קורה אם יש לי מצב רפואי או רגישות?",
      "faq-6-a": "לפני הייעוץ ממלאים טפסי הכנה. מידע רפואי רלוונטי נבדק על ידי הקליניקה כדי ששיקולי בטיחות יילקחו בחשבון לפני החלטה טיפולית.",
      "faq-7-q": "האם יש מעקב אחרי טיפול?",
      "faq-7-a": "כן. מעקב הוא חלק מחוויית Linnéa. מקבלים הנחיות לאחר טיפול והצוות בודק שהכול ברור ונוח כשזה רלוונטי.",
      "faq-8-q": "האם אפשר לתאם מחדש?",
      "faq-8-a": "כן. אם מועד לא מתאים או שהתוכניות משתנות, אפשר להשיב לקליניקה ונציע אפשרות אחרת.",
      ...
      "alt-temples-after": "תוצאה אחרי שליטה בחומרי מילוי באזור הרקות במרפאת לינאה",
      "alt-temples-before": "לפני שליטה בחומרי מילוי באזור הרקות במרפאת לינאה",
