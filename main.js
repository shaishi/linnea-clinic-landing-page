...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "hero-subtitle": "Personal aesthetic consultations by a dual-doctor team, designed for refined, natural and harmonious results.",
      "method-kicker": "The Linnéa Method",
      "method-title": "A quieter standard for aesthetic medicine",
      "method-desc": "Every consultation is built around medical clarity, facial harmony and restraint, so the result feels refined rather than treated.",
