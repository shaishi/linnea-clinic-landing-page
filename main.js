...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "hero-lead": "Two doctors. One considered treatment plan.",
      "hero-subtitle": "Every treatment at Linnéa is planned collaboratively, combining two medical perspectives with a focus on precision, restraint and natural results.",
      "btn-view-results": "View Our Results",
      "about-title": "Our Approach",
      "about-p1": "Linnéa approaches aesthetic medicine through careful assessment, collaborative planning and restrained intervention — refining what is already there, without overworking it.",
      ...
      "about-p3": "Beyond medical excellence, the professional dialogue between us allows us to examine every angle and detail of the treatment plan, with dual oversight guaranteeing maximum precision and uncompromising safety. We are committed to results that are balanced and natural.",
      "principle-1-title": "Dual Perspective",
      "principle-1-desc": "Every treatment plan is reviewed by two doctors.",
      "principle-2-title": "Medical Precision",
      "principle-2-desc": "Evidence-based treatments, carefully selected and precisely performed.",
      "principle-3-title": "Natural Restraint",
      "principle-3-desc": "Enhancement without changing what makes you look like you.",
      "doc-intro": "Two perspectives. One treatment philosophy.",
      ...
      "location-desc": "Linnéa is located on Menachem Begin Road, in central Tel Aviv.",
      ...
      "footer-tagline": "Considered aesthetic medicine, shaped by precision and restraint.",
      "footer-explore": "Explore",
      "footer-contact": "Contact Us",
      "footer-address": "Menachem Begin 150, Tel Aviv, Israel",
      "footer-discuss": "Let's discuss your treatment plan.",
      "footer-rights": "© 2026 Linnéa Aesthetic Clinic. All rights reserved.",
      "modal-title": "Book a Consultation",
      "modal-desc": "Share a few details and our team will be in touch to arrange your visit.",
      ...
      "transformations-title": "Subtle Changes. Considered Results.",
      "transformations-desc": "Real results from considered treatment plans.",
      "before-label": "Before",
      "after-label": "After",
      ...
      "articles-desc": "Notes on treatments, technique and the evidence behind them.",
      "read-more": "Read More",
      ...
      "article1-desc": "How precise neuromodulator dosing softens expression lines without flattening them.",
      ...
      "article1-p5": "Safety, precision, and artistry are our top priorities. During your consultation, our medical experts map your facial anatomy to design a considered treatment plan, so every unit of product serves a specific, harmonising purpose.",
      ...
      "article2-desc": "Restoring volume and structure with hyaluronic acid, guided by facial anatomy.",
      ...
      "article2-p5": "We combine this approach with rigorous medical safety. By using micro-cannulas and precise anatomical mapping, our injectors minimise downtime and maximise comfort. The result is refined, and true to your natural bone structure.",
      "article3-title": "The Science of Longevity",
      "article3-subtitle": "Evidence-based approaches to cellular health and long-term skin quality.",
      "article3-desc": "An evidence-based look at skin health at the cellular level.",
      "alt-hero": "A Linnéa doctor performing a precise injectable treatment, Tel Aviv skyline in view",
      ...
      "doc-p3": "Every case is planned jointly with Dr. Khoury, combining two clinical perspectives before a treatment begins.",
      ...
      "doc2-p3": "Every treatment plan is reviewed jointly with Dr. Shiloh, so each decision reflects two medical perspectives, not one.",
      ...
      "cat-skin-quality": "Skin Quality",
      "cat-facial-harmonisation": "Facial Harmonisation",
      "cat-neuromodulators": "Neuromodulators",
      "cat-regenerative": "Regenerative Treatments",
      "ffr-title": "Full Face Harmonisation",
      "ffr-desc": "Fillers and neuromodulators planned together across the full face for balanced results.",
      ...
      "pn-desc": "Biological molecules that support cellular regeneration and skin quality.",
      ...
      "skinbooster-desc": "Deep hydration that improves skin elasticity and texture.",
      ...
      "acne-desc": "Combined injection techniques that soften scarring and refine skin texture.",
    ...
    he: {
      ...
      "hero-lead": "שני רופאים. תוכנית טיפול אחת מתוכננת בקפידה.",
      "hero-subtitle": "כל טיפול בלינאה מתוכנן בשיתוף פעולה, המשלב שתי נקודות מבט רפואיות עם דגש על דיוק, איפוק ותוצאה טבעית.",
      "btn-view-results": "לתוצאות שלנו",
      "about-title": "הגישה שלנו",
      "about-p1": "לינאה ניגשת לרפואה אסתטית באמצעות הערכה מדוקדקת, תכנון משותף והתערבות מאופקת — מחדדת את מה שכבר קיים, בלי לעבד אותו יתר על המידה.",
      "principle-1-title": "נקודת מבט כפולה",
      "principle-1-desc": "כל תוכנית טיפול נבחנת על ידי שני רופאים.",
      "principle-2-title": "דיוק רפואי",
      "principle-2-desc": "טיפולים מבוססי ראיות, נבחרים ומבוצעים בקפידה.",
      "principle-3-title": "איפוק טבעי",
      "principle-3-desc": "שיפור בלי לשנות את מה שהופך אתכם למי שאתם.",
      "doc-intro": "שתי נקודות מבט. פילוסופיית טיפול אחת.",
      ...
      "location-desc": "לינאה ממוקמת בשדרות מנחם בגין, בלב תל אביב.",
      "address-label": "כתובת:",
      ...
      "map-placeholder": "מפה",
      "footer-tagline": "רפואה אסתטית מדודה, מעוצבת מתוך דיוק ואיפוק.",
      ...
      "modal-desc": "שתפו כמה פרטים וניצור איתכם קשר לתיאום הביקור.",
      "label-name": "שם מלא",
      ...
      "transformations-title": "שינויים עדינים. תוצאות מדודות.",
      "transformations-desc": "תוצאות אמיתיות מתוכניות טיפול מדודות.",
      "before-label": "לפני",
      "after-label": "אחרי",
      "slider-before": "לפני",
      "slider-after": "אחרי",
      ...
      "articles-desc": "הערות על טיפולים, טכניקה והראיות שמאחוריהן.",
      "read-more": "קראו עוד",
      "article1-title": "אמנות הבוטוקס",
      "article1-subtitle": "צלילה עמוקה אל עולם הנוירומודולטורים והבעות הפנים הטבעיות.",
      "article1-desc": "כיצד מינון מדויק של נוירומודולטורים מרכך קמטי הבעה מבלי לשטח אותם.",
      ...
      "article2-desc": "שחזור נפח ומבנה בעזרת חומצה היאלורונית, בהתאם לאנטומיית הפנים.",
      ...
      "article2-p5": "אנו משלבים את הגישה הזו עם בטיחות רפואית קפדנית. באמצעות מיקרו-קנולות ומיפוי אנטומי מדויק, המזריקים שלנו ממזערים את זמן ההחלמה ומעניקים תוצאה מעודנת הנאמנה למבנה העצם הטבעי שלך.",
      "article3-title": "מדע אריכות הימים",
      "article3-subtitle": "גישות מבוססות-ראיות לבריאות התא ואיכות העור לאורך זמן.",
      "article3-desc": "מבט מבוסס-ראיות על בריאות העור ברמה התאית.",
      "alt-hero": "רופאה בקליניקת לינאה מבצעת טיפול הזרקה מדויק, נוף קו הרקיע של תל אביב ברקע",
      ...
      "doc-p3": "כל מקרה מתוכנן יחד עם ד\"ר ח'ורי, ומשלב שתי נקודות מבט קליניות לפני תחילת הטיפול.",
      ...
      "doc2-p3": "כל תוכנית טיפול נבחנת יחד עם ד\"ר שילה, כך שכל החלטה משקפת שתי נקודות מבט רפואיות.",
      ...
      "cat-skin-quality": "איכות העור",
      "cat-facial-harmonisation": "הרמוניה של הפנים",
      "cat-neuromodulators": "נוירומודולטורים",
      "cat-regenerative": "טיפולים רגנרטיביים",
      "ffr-title": "הרמוניזציה מלאה של הפנים",
      "ffr-desc": "חומרי מילוי ונוירומודולטורים המתוכננים יחד על פני כל הפנים לתוצאה מאוזנת.",
      ...
      "pn-desc": "מולקולות ביולוגיות התומכות בהתחדשות תאית ובאיכות העור.",
      ...
      "skinbooster-desc": "לחות עמוקה לשכבות העור ושיפור האלסטיות והמרקם.",
      ...
      "acne-desc": "שילוב טכניקות הזרקה לריכוך צלקות ושיפור מרקם העור.",
