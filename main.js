...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "about-p1": "We believe that aesthetics is not about altering, but rather refining existing beauty. At Linnéa, a Nordic-inspired boutique clinic, we combine advanced science with a refined, human-centered approach, providing you with a space of tranquility and complete confidence throughout your journey.",
    ...
    he: {
      ...
      "about-p1": "אנו מאמינים שאסתטיקה אינה שינוי, אלא זיקוק של היופי הקיים. ב-Linnéa, קליניקת בוטיק ברוח נורדית, אנו מחברים בין מדע מתקדם לגישה אנושית ומעודנת, המעניקה לך מרחב של שקט וביטחון מלא לאורך כל הדרך.",
